...
export class GetAccountInfoResponse_CryptoAsset extends Message<GetAccountInfoResponse_CryptoAsset> {
  ...
  static fromJson(
    ...
    return new GetAccountInfoResponse_CryptoAsset().fromJson(
      jsonValue,
      options,
    );
  }
  ...
  static fromJsonString(
    ...
    return new GetAccountInfoResponse_CryptoAsset().fromJsonString(
      jsonString,
      options,
    );
  }
  ...
  static equals(
    a:
      | GetAccountInfoResponse_CryptoAsset
      | PlainMessage<GetAccountInfoResponse_CryptoAsset>
      | undefined,
    b:
      | GetAccountInfoResponse_CryptoAsset
      | PlainMessage<GetAccountInfoResponse_CryptoAsset>
...
export class EstimateOnRampFeeRequest extends Message<EstimateOnRampFeeRequest> {
  ...
  static equals(
    a:
      | EstimateOnRampFeeRequest
      | PlainMessage<EstimateOnRampFeeRequest>
      | undefined,
    b:
      | EstimateOnRampFeeRequest
      | PlainMessage<EstimateOnRampFeeRequest>
...
export class EstimateOnRampFeeResponse extends Message<EstimateOnRampFeeResponse> {
  ...
  static equals(
    a:
      | EstimateOnRampFeeResponse
      | PlainMessage<EstimateOnRampFeeResponse>
      | undefined,
    b:
      | EstimateOnRampFeeResponse
      | PlainMessage<EstimateOnRampFeeResponse>
...
export class EstimateOffRampFeeRequest extends Message<EstimateOffRampFeeRequest> {
  ...
  static equals(
    a:
      | EstimateOffRampFeeRequest
      | PlainMessage<EstimateOffRampFeeRequest>
      | undefined,
    b:
      | EstimateOffRampFeeRequest
      | PlainMessage<EstimateOffRampFeeRequest>
...
export class EstimateOffRampFeeResponse extends Message<EstimateOffRampFeeResponse> {
  ...
  static equals(
    a:
      | EstimateOffRampFeeResponse
      | PlainMessage<EstimateOffRampFeeResponse>
      | undefined,
    b:
      | EstimateOffRampFeeResponse
      | PlainMessage<EstimateOffRampFeeResponse>
